        ...
        >
            ...
            >
                <span
                    ...
                    aria-hidden="true"
                >
                    <svg className="bg-white h-3 w-3 text-gray-600" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" >
                ...
                <span
                    ...
                    aria-hidden="true"
                >
                    <svg className="bg-white h-3 w-3 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20 " fill="currentColor">
